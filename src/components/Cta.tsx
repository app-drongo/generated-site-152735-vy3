...
// Generated: 2025-08-19T09:35:39.004Z
// Section: cta
// Category: cta
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Unlock your organization's full potential with our strategic insights and innovative solutions. 
                Join thousands of successful businesses who have trusted Acme Consulting to drive sustainable growth.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Discover how Acme Consulting can transform your business
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Benefit from our team's extensive industry knowledge and experience
              </p>
            </div>
