...
// Generated: 2025-08-19T09:35:38.741Z
// Section: footer
// Category: footer
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: "Change Management", href: "#change" },
        { name: "Operations Optimization", href: "#operations" },
        { name: "Industry Expertise", href: "#industry" }
      ]
    },
    {
      title: "About Acme",
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                ...
                Trusted by leading organizations worldwide to drive sustainable growth and success.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get the latest industry insights and news. Unsubscribe anytime.
              </p>
            </div>
          </div>
      ...
      <div className="border-t border-border/50 bg-muted/20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-6 mt-4 pt-4 border-t border-border/30">
            ...
            <Link href="/resources" className="text-xs text-muted-foreground hover:text-foreground transition-colors">
              Resources
            </Link>
